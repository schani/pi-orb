...
33. Prevent a draining control-plane revision's reconciler from provisioning hosts with a stale startup script (§3.3 rollout caveat): e.g. stamp the script version into instance metadata and treat a mismatch as a replaceable host.
