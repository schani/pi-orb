...
- [docs/transcript-model.md](docs/transcript-model.md) — the client-independent transcript model, its JSON fixture projections for cross-client checks, and the seeded generator
