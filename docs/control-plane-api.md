...
interface OrbView {
  ...
  identity?: {
    failureCode: "invalid_request" | "not_mintable" | "rate_limited" | "signer_failure"
      | "store_unavailable";
    failureAt: string;
  };
  createdAt: string;
