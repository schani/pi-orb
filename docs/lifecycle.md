...
A field incident on 2026-08-05 showed that the inline unreachable-runtime restart livelocks against real VM boot times (38 stop/start cycles against a ~65 s boot under a 30 s grace). Forensics: `docs/postmortems/2026-08-05-unreachable-restart-livelock.md`; the fix is tracked in `TODO.md`.
